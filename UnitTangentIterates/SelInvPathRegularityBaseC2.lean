...
`SelInvFrontNormalSpeedBaseC2.dist_selInv_le_of_front_normalSpeed_base_C2` still carries
...
Main result: `dist_selInv_le_of_path_regularity_base_C2`.
-/
...
namespace SelInvPathRegularityBaseC2

open SelInvPathRegularityFundamentalDriftC2
...
`SelInvFrontNormalSpeedBaseC2.dist_selInv_le_of_front_normalSpeed_base_C2` with the
...
curve. -/
theorem dist_selInv_le_of_path_regularity_base_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvFrontNormalSpeedBaseC2.dist_selInv_le_of_front_normalSpeed_base_C2
...
end SelInvPathRegularityBaseC2
