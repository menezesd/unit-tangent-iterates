...
current source, without postulating a new `Source`.
-/
...
theorem Source.successorFrontCore
    {p q : Data} {Gamma : NormalPath p q} {P0 kh khat Qmax : ℝ}
    (A : Source Gamma P0 kh khat Qmax) : Core A := by
...
end FiniteSmoothRearFamilySuccessorFront
