...
`SelInvFrontNormalSpeedFundamentalDriftC2.dist_selInv_le_of_front_normalSpeed_fundamental_drift_C2` still carries
...
Main result: `dist_selInv_le_of_path_regularity_fundamental_drift_C2`.
-/
...
namespace SelInvPathRegularityFundamentalDriftC2

open SelInvPathRegularityFundamentalC2

open SelInvPathRegularityC2
...
`SelInvFrontNormalSpeedFundamentalDriftC2.dist_selInv_le_of_front_normalSpeed_fundamental_drift_C2` with the
...
curve. -/
theorem dist_selInv_le_of_path_regularity_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvFrontNormalSpeedFundamentalDriftC2.dist_selInv_le_of_front_normalSpeed_fundamental_drift_C2
    ...
    hkappa1 hxi0 hetaC1 hnumA hnumK hsmall

end SelInvPathRegularityFundamentalDriftC2
