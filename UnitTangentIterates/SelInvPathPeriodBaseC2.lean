...
`SelInvPathCurvatureBaseC2.exists_steering_dist_selInv_le_of_path_curvature_base_C2`
...
Main result: `exists_steering_dist_selInv_le_of_path_period_base_C2`.
-/
...
namespace SelInvPathPeriodBaseC2

open SelInvPathPeriodFundamentalDriftC2
...
those of
`SelInvPathCurvatureBaseC2.exists_steering_dist_selInv_le_of_path_curvature_base_C2` with
...
theorem exists_steering_dist_selInv_le_of_path_period_base_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathCurvatureBaseC2.exists_steering_dist_selInv_le_of_path_curvature_base_C2
