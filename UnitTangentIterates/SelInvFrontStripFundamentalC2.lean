...
Main result: `dist_selInv_le_of_front_strip_fundamental_C2`.
-/
...
namespace SelInvFrontStripFundamentalC2
...
`SelInvFrontSourceFundamentalC2.dist_selInv_le_of_front_source_fundamental_C2`, with the derivative of
...
theorem dist_selInv_le_of_front_strip_fundamental_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvFrontSourceFundamentalC2.dist_selInv_le_of_front_source_fundamental_C2
    ...
    hRbd hRbm hr hxi0 hgSex hetaU hetaUbd hnumA hnumK hsmall

end SelInvFrontStripFundamentalC2
