...
`SelInvPathRegularityFundamentalDriftC2.dist_selInv_le_of_path_regularity_fundamental_drift_C2` still asks the
...
Main result: `dist_selInv_le_of_path_angle_fundamental_drift_C2`.
-/
...
namespace SelInvPathAngleFundamentalDriftC2

open SelInvPathAngleFundamentalC2

open SelInvPathAngleC2
...
`SelInvPathRegularityFundamentalDriftC2.dist_selInv_le_of_path_regularity_fundamental_drift_C2` with the joint
...
theorem dist_selInv_le_of_path_angle_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathRegularityFundamentalDriftC2.dist_selInv_le_of_path_regularity_fundamental_drift_C2
...
end SelInvPathAngleFundamentalDriftC2
