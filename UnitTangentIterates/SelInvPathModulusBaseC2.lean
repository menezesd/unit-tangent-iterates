...
`SelInvPathLiftBaseC2.dist_selInv_le_of_path_lift_base_C2` bounds the marked distance of
...
Main result: `dist_selInv_le_modulus_of_path_base_C2`.
-/
...
namespace SelInvPathModulusBaseC2

open SelInvPathModulusFundamentalDriftC2
...
form.**  The bound of `SelInvPathLiftBaseC2.dist_selInv_le_of_path_lift_base_C2` is the
...
theorem dist_selInv_le_modulus_of_path_base_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  obtain ⟨dn, δ, hdnper, hstrip, hsol, hdelta, hmain⟩ :=
    SelInvPathLiftBaseC2.dist_selInv_le_of_path_lift_base_C2
  ...
  obtain ⟨hperp, hperq, -, -, -, -, hbound⟩ :=
    hmain Pv0 khat hkappa1 hnumA hnumK hsmall
  rw [hperp, hperq]
  exact hbound

end SelInvPathModulusBaseC2
