...
`SelInvPathLiftFundamentalC2.dist_selInv_le_of_path_lift_fundamental_C2` bounds the marked distance of
...
Main result: `dist_selInv_le_modulus_of_path_fundamental_C2`.
-/
...
namespace SelInvPathModulusFundamentalC2
...
form.**  The bound of `SelInvPathLiftFundamentalC2.dist_selInv_le_of_path_lift_fundamental_C2` is the
...
theorem dist_selInv_le_modulus_of_path_fundamental_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  obtain ⟨dn, δ, hdnper, hstrip, hsol, hdelta, hmain⟩ :=
    SelInvPathLiftFundamentalC2.dist_selInv_le_of_path_lift_fundamental_C2
  ...
  obtain ⟨hperp, hperq, -, -, -, -, hbound⟩ :=
    hmain Rb Pv0 khat rr hkappa1 hRbd hRbm hr hxi0 hnumA hnumK hsmall
  rw [hperp, hperq]
  exact hbound

end SelInvPathModulusFundamentalC2
