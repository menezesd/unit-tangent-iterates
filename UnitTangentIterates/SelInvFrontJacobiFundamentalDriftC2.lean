...
`SelInvFrontMixedFundamentalDriftC2.dist_selInv_le_of_front_mixed_fundamental_drift_C2` still assumes the inverse
Jacobi ODE
...
* `dist_selInv_le_of_front_jacobi_fundamental_drift_C2` — the estimate with the inverse Jacobi
...
namespace SelInvFrontJacobiFundamentalDriftC2
...
theorem dist_selInv_le_of_front_jacobi_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvFrontMixedFundamentalDriftC2.dist_selInv_le_of_front_mixed_fundamental_drift_C2 (etaF := fun t' s => Γ.eta t' (s / P t'))
    ...
    hlink hkappa1 hxi0 hetaU hetaUbd hnumA hnumK hsmall

end SelInvFrontJacobiFundamentalDriftC2
