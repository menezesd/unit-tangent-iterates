...
`SelInvFrontVelocityFundamentalDriftC2.dist_selInv_le_of_front_velocity_fundamental_drift_C2` still asks
...
`dist_selInv_le_of_front_regularity_fundamental_drift_C2`.
-/
...
namespace SelInvFrontRegularityFundamentalDriftC2

open SelInvFrontRegularityFundamentalC2
...
`SelInvFrontVelocityFundamentalDriftC2.dist_selInv_le_of_front_velocity_fundamental_drift_C2` with the four
...
theorem dist_selInv_le_of_front_regularity_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvFrontVelocityFundamentalDriftC2.dist_selInv_le_of_front_velocity_fundamental_drift_C2
...
end SelInvFrontRegularityFundamentalDriftC2
