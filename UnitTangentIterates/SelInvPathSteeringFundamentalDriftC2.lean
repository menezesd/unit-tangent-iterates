...
`SelInvPathAngleFundamentalDriftC2.dist_selInv_le_of_path_angle_fundamental_drift_C2` still asks the selected
...
Main result: `dist_selInv_le_of_path_steering_fundamental_drift_C2`.
-/
...
namespace SelInvPathSteeringFundamentalDriftC2

open SelInvPathSteeringFundamentalC2
...
hypotheses are those of `SelInvPathAngleFundamentalDriftC2.dist_selInv_le_of_path_angle_fundamental_drift_C2` with
...
theorem dist_selInv_le_of_path_steering_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathAngleFundamentalDriftC2.dist_selInv_le_of_path_angle_fundamental_drift_C2
...
end SelInvPathSteeringFundamentalDriftC2
