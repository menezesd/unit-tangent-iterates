...
`SelInvPathPeriodFundamentalDriftC2.exists_steering_dist_selInv_le_of_path_period_fundamental_drift_C2` carries,
...
Main result: `exists_steering_dist_selInv_le_of_path_embedded_fundamental_drift_C2`.
-/
...
namespace SelInvPathEmbeddedFundamentalDriftC2

open SelInvPathEmbeddedFundamentalC2
...
`SelInvPathPeriodFundamentalDriftC2.exists_steering_dist_selInv_le_of_path_period_fundamental_drift_C2` with the
...
theorem exists_steering_dist_selInv_le_of_path_embedded_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  refine SelInvPathPeriodFundamentalDriftC2.exists_steering_dist_selInv_le_of_path_period_fundamental_drift_C2
...
end SelInvPathEmbeddedFundamentalDriftC2
