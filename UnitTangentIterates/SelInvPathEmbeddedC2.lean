...
`SelInvPathPeriodC2.exists_steering_dist_selInv_le_of_path_period_C2` carries,
...
Main result: `exists_steering_dist_selInv_le_of_path_embedded_C2`.
-/
...
namespace SelInvPathEmbeddedC2
...
`SelInvPathPeriodC2.exists_steering_dist_selInv_le_of_path_period_C2` with the
...
theorem exists_steering_dist_selInv_le_of_path_embedded_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  refine exists_steering_dist_selInv_le_of_path_period_C2
