...
`SelInvPathRegularityBaseC2.dist_selInv_le_of_path_regularity_base_C2` still asks the
...
Main result: `dist_selInv_le_of_path_angle_base_C2`.
-/
...
namespace SelInvPathAngleBaseC2

open SelInvPathAngleFundamentalDriftC2
...
`SelInvPathRegularityBaseC2.dist_selInv_le_of_path_regularity_base_C2` with the joint
...
theorem dist_selInv_le_of_path_angle_base_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathRegularityBaseC2.dist_selInv_le_of_path_regularity_base_C2
