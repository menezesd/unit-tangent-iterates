...
`SelInvPathEmbeddedFundamentalC2.exists_steering_dist_selInv_le_of_path_embedded_fundamental_C2` still
...
Main result: `dist_selInv_le_of_path_lift_fundamental_C2`.
-/
...
namespace SelInvPathLiftFundamentalC2
...
of
`SelInvPathEmbeddedFundamentalC2.exists_steering_dist_selInv_le_of_path_embedded_fundamental_C2` with
...
`2κ̂/√(1−κ̂²)³`. -/
theorem dist_selInv_le_of_path_lift_fundamental_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathEmbeddedFundamentalC2.exists_steering_dist_selInv_le_of_path_embedded_fundamental_C2
...
end SelInvPathLiftFundamentalC2
