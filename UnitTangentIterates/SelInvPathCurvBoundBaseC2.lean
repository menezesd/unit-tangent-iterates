...
`SelInvPathModulusBaseC2.dist_selInv_le_modulus_of_path_base_C2` still asks separately
...
Main result: `dist_selInv_le_modulus_of_path_curv_base_C2`.
-/
...
namespace SelInvPathCurvBoundBaseC2

open SelInvPathCurvBoundFundamentalDriftC2
...
`SelInvPathModulusBaseC2.dist_selInv_le_modulus_of_path_base_C2` with the two curvature
...
theorem dist_selInv_le_modulus_of_path_curv_base_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  refine SelInvPathModulusBaseC2.dist_selInv_le_modulus_of_path_base_C2 Γ hc hkmin hp ?_ hturnp hcq hkminq hq ?_ hturnq
