...
`SelInvPathRegularityFundamentalC2.dist_selInv_le_of_path_regularity_fundamental_C2` still asks the
...
Main result: `dist_selInv_le_of_path_angle_fundamental_C2`.
-/
...
namespace SelInvPathAngleFundamentalC2
...
`SelInvPathRegularityFundamentalC2.dist_selInv_le_of_path_regularity_fundamental_C2` with the joint
...
theorem dist_selInv_le_of_path_angle_fundamental_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathRegularityFundamentalC2.dist_selInv_le_of_path_regularity_fundamental_C2
...
end SelInvPathAngleFundamentalC2
