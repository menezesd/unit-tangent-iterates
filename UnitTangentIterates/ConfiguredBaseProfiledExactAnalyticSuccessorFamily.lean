...
namespace ConfiguredBaseProfiledExactAnalyticSuccessorFamily
...
private theorem edgeSource_period_eq
    (O : ConfiguredRecursiveSourceP0ScalarStart.Output MA NA) (n : ℕ) :
...
theorem edgePeriodUpper_le_edgeP1
  ...
  (edgePeriodUpper_le_wideP1 O MA n).trans (le_max_right _ _)
...
structure EdgeSlicedAnalyticFamily
    (O : ConfiguredRecursiveSourceP0ScalarStart.Output MA NA) : Type where
...
end ConfiguredBaseProfiledExactAnalyticSuccessorFamily
