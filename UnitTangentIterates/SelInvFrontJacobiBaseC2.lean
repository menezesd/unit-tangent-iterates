...
`SelInvFrontMixedBaseC2.dist_selInv_le_of_front_mixed_base_C2` still assumes the inverse
Jacobi ODE
...
* `dist_selInv_le_of_front_jacobi_base_C2` — the estimate with the inverse Jacobi
...
namespace SelInvFrontJacobiBaseC2

open SelInvFrontJacobiFundamentalDriftC2

open SelInvFrontJacobiFundamentalC2
...
theorem dist_selInv_le_of_front_jacobi_base_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvFrontMixedBaseC2.dist_selInv_le_of_front_mixed_base_C2 (etaF := fun t' s => Γ.eta t' (s / P t'))
    ...
    hlink hkappa1 hetaU hetaUbd hnumA hnumK hsmall

end SelInvFrontJacobiBaseC2
