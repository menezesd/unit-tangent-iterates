...
`SelInvFrontClosingFundamentalDriftC2.dist_selInv_le_of_front_closing_fundamental_drift_C2` still carries the
...
`dist_selInv_le_of_front_normalSpeed_fundamental_drift_C2`.
-/
...
namespace SelInvFrontNormalSpeedFundamentalDriftC2

open SelInvFrontNormalSpeedFundamentalC2
...
`SelInvFrontClosingFundamentalDriftC2.dist_selInv_le_of_front_closing_fundamental_drift_C2` with that derivative
and its bound replaced by the joint requirement that the normal speed be `C¹`
in the parameter. -/
theorem dist_selInv_le_of_front_normalSpeed_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvFrontClosingFundamentalDriftC2.dist_selInv_le_of_front_closing_fundamental_drift_C2
    ...
    hkappa1 hxi0 hetaU hetaUbd hnumA hnumK hsmall

end SelInvFrontNormalSpeedFundamentalDriftC2
