import UnitTangentIterates.FiniteSmoothRearFamilyCorrelatedCapRowBounds
...
namespace ConfiguredCorrelatedPhysicalProducerFromCap
...
def physicalProducer_of_capFamily
    ...
    (hpathConversion : ∀ n,
      c2ConstVar (rowP0 (shift D L.N) n) (P1 n)
        (khat n) (G1 n) (Cg n) ≤
  ...
  have hpathRadius : ∀ n,
      c2ConstVar (rowP0 D' n) (P1 n) (khat n) (G1 n) (Cg n) *
...
end ConfiguredCorrelatedPhysicalProducerFromCap
