...
`SelInvFrontMotionFundamentalC2.dist_selInv_le_of_front_motion_fundamental_C2` still asks the caller
...
Main result: `dist_selInv_le_of_front_mixed_fundamental_C2`.
-/
...
namespace SelInvFrontMixedFundamentalC2
...
than assumed.** -/
theorem dist_selInv_le_of_front_mixed_fundamental_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvFrontMotionFundamentalC2.dist_selInv_le_of_front_motion_fundamental_C2
    ...
    hlink hkappa1 hmixed hRbd hRbm hr hxi0 hetaU hetaUbd hnumA hnumK hsmall

end SelInvFrontMixedFundamentalC2
