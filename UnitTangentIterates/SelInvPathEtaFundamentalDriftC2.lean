...
`SelInvPathCurvBoundFundamentalDriftC2.dist_selInv_le_modulus_of_path_curv_fundamental_drift_C2` still asks that
...
Main result: `dist_selInv_le_modulus_of_path_eta_fundamental_drift_C2`.
-/
...
namespace SelInvPathEtaFundamentalDriftC2
...
`SelInvPathCurvBoundFundamentalDriftC2.dist_selInv_le_modulus_of_path_curv_fundamental_drift_C2` with the `C¹`
...
normal. -/
theorem dist_selInv_le_modulus_of_path_eta_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
    ...
    ∃ dn δ : ℝ → ℝ → ℝ,
      ...
      dist (SelectedInverseMap.selInv kh q) (SelectedInverseMap.selInv kh p)
        ≤ selInvFrontModulus P1 kh (perim (SelectedInverseMap.selInv kh p))
            ...
            (cost Γ) := by
  refine SelInvPathCurvBoundFundamentalDriftC2.dist_selInv_le_modulus_of_path_curv_fundamental_drift_C2 Γ hc hkmin hp hturnp hcq hkminq hq hturnq
...
end SelInvPathEtaFundamentalDriftC2
