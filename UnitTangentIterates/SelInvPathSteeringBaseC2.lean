...
`SelInvPathAngleBaseC2.dist_selInv_le_of_path_angle_base_C2` still asks the selected
...
Main result: `dist_selInv_le_of_path_steering_base_C2`.
-/
...
namespace SelInvPathSteeringBaseC2

open SelInvPathSteeringFundamentalDriftC2
...
hypotheses are those of `SelInvPathAngleBaseC2.dist_selInv_le_of_path_angle_base_C2` with
...
theorem dist_selInv_le_of_path_steering_base_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathAngleBaseC2.dist_selInv_le_of_path_angle_base_C2
