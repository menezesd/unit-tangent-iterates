...
`SelInvFrontMotionC2.dist_selInv_le_of_front_motion_C2` still asks the caller
...
Main result: `dist_selInv_le_of_front_mixed_C2`.
-/
...
than assumed.** -/
theorem dist_selInv_le_of_front_mixed_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact dist_selInv_le_of_front_motion_C2
    ...
    hlink hkappa1 hmixed hRbd hRbm hr hetaU hetaUbd hnumA hnumK hsmall

end SelInvFrontMixedC2
