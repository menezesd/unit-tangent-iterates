...
`SelInvFrontRegularityFundamentalDriftC2.dist_selInv_le_of_front_regularity_fundamental_drift_C2` still carries
...
`dist_selInv_le_of_front_changevar_fundamental_drift_C2`.
-/
...
namespace SelInvFrontChangeVarFundamentalDriftC2
...
theorem dist_selInv_le_of_front_changevar_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvFrontRegularityFundamentalDriftC2.dist_selInv_le_of_front_regularity_fundamental_drift_C2
...
end SelInvFrontChangeVarFundamentalDriftC2
