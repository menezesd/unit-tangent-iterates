...
`SelInvPathPeriodBaseC2.exists_steering_dist_selInv_le_of_path_period_base_C2` carries,
...
Main result: `exists_steering_dist_selInv_le_of_path_embedded_base_C2`.
-/
...
namespace SelInvPathEmbeddedBaseC2

open SelInvPathEmbeddedFundamentalDriftC2
...
`SelInvPathPeriodBaseC2.exists_steering_dist_selInv_le_of_path_period_base_C2` with the
...
theorem exists_steering_dist_selInv_le_of_path_embedded_base_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  refine SelInvPathPeriodBaseC2.exists_steering_dist_selInv_le_of_path_period_base_C2
