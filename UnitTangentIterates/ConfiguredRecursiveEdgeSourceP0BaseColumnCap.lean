...
/-! # Configured base cap at the successor-edge floor -/

noncomputable section

open Set MarkedSpace

namespace ConfiguredRecursiveEdgeSourceP0BaseColumnCap
    ...
    have hterminal :
      ...
      calc
        _ = RichStageDataPhaseRigidTransport.move A.translation A.rotation
            ...
            (S.carrier n).data := by
          simpa [ConfiguredRecursiveEdgeSourceP0ConstructionCoreProvider.baseCorrelated,
            ConfiguredRecursiveEdgeSourceP0ConstructionCoreProvider.baseProvider,
...
end ConfiguredRecursiveEdgeSourceP0BaseColumnCap
