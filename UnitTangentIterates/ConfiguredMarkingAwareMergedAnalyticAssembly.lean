...
import UnitTangentIterates.ConfiguredActualHalfMergedScalarStart
...
namespace ConfiguredMarkingAwareMergedAnalyticAssembly
...
theorem conclude
    ...
    {MA0 NA0 Mend Cw : ℝ}
    (L : Output D
      (mergedCombinedConversion D MA0 NA0 (analyticKhat D) sourceKh Mend)
      (physicalDefect D) Cw)
  ...
  · exact mergedEndpointConversion_nonnegative D sourceKh_nonnegative sourceKh_lt_one
...
end ConfiguredMarkingAwareMergedAnalyticAssembly
