...
`SelInvFrontBaseDriftC2.dist_selInv_le_of_front_base_drift_C2` still asks the caller for
...
* `dist_selInv_le_of_front_motion_base_C2` — the estimate with `alphaT`, `kT` and
...
namespace SelInvFrontMotionBaseC2

open SelInvFrontMotionFundamentalDriftC2

open SelInvFrontMotionFundamentalC2

open SelInvFrontMotionC2
...
theorem dist_selInv_le_of_front_motion_base_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvFrontBaseDriftC2.dist_selInv_le_of_front_base_drift_C2
    ...
    hlink hkappa1 halphaT hkT halphaTc hkTc halphaTS hmixed
     hetaU hetaUbd hnumA hnumK hsmall

end SelInvFrontMotionBaseC2
