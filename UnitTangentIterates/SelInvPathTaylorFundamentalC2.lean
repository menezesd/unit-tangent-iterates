...
`SelInvPathSteeringFundamentalC2.dist_selInv_le_of_path_steering_fundamental_C2` still carries, besides
...
Main result: `dist_selInv_le_of_path_taylor_fundamental_C2`.
-/
...
namespace SelInvPathTaylorFundamentalC2
...
`SelInvPathSteeringFundamentalC2.dist_selInv_le_of_path_steering_fundamental_C2` with the time
...
theorem dist_selInv_le_of_path_taylor_fundamental_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathSteeringFundamentalC2.dist_selInv_le_of_path_steering_fundamental_C2 (Kdn := partialT Kn) (Pd := deriv P)
...
end SelInvPathTaylorFundamentalC2
