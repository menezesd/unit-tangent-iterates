...
`SelInvPathSteeringExistsBaseC2.exists_steering_dist_selInv_le_of_path_base_C2` still
...
Main result: `exists_steering_dist_selInv_le_of_path_curvature_base_C2`.
-/
...
namespace SelInvPathCurvatureBaseC2

open SelInvPathCurvatureFundamentalDriftC2
...
those of
`SelInvPathSteeringExistsBaseC2.exists_steering_dist_selInv_le_of_path_base_C2` with the
...
theorem exists_steering_dist_selInv_le_of_path_curvature_base_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathSteeringExistsBaseC2.exists_steering_dist_selInv_le_of_path_base_C2 (Kn := pathKn Γ.X P)
