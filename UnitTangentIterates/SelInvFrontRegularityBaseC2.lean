...
`SelInvFrontVelocityBaseC2.dist_selInv_le_of_front_velocity_base_C2` still asks
...
`dist_selInv_le_of_front_regularity_base_C2`.
-/
...
namespace SelInvFrontRegularityBaseC2

open SelInvFrontRegularityFundamentalDriftC2
...
`SelInvFrontVelocityBaseC2.dist_selInv_le_of_front_velocity_base_C2` with the four
...
theorem dist_selInv_le_of_front_regularity_base_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvFrontVelocityBaseC2.dist_selInv_le_of_front_velocity_base_C2
...
end SelInvFrontRegularityBaseC2
