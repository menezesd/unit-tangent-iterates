...
`SelInvPathSteeringFundamentalDriftC2.dist_selInv_le_of_path_steering_fundamental_drift_C2` still carries, besides
...
Main result: `dist_selInv_le_of_path_taylor_fundamental_drift_C2`.
-/
...
namespace SelInvPathTaylorFundamentalDriftC2
...
`SelInvPathSteeringFundamentalDriftC2.dist_selInv_le_of_path_steering_fundamental_drift_C2` with the time
...
theorem dist_selInv_le_of_path_taylor_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathSteeringFundamentalDriftC2.dist_selInv_le_of_path_steering_fundamental_drift_C2 (Kdn := partialT Kn) (Pd := deriv P)
...
end SelInvPathTaylorFundamentalDriftC2
