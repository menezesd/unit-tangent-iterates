...
namespace ConfiguredAnalyticKhatCombinedCorrelatedAssembly
...
theorem conclude
    ...
    (F : ConstructionCore
      ...
      (fun _ ↦ sourceKh) Qmax Mtotal a MA NA K0 K1 K2)
    (R : CapFamily F
...
end ConfiguredAnalyticKhatCombinedCorrelatedAssembly
