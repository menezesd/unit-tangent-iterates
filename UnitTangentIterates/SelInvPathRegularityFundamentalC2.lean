...
`SelInvFrontNormalSpeedFundamentalC2.dist_selInv_le_of_front_normalSpeed_fundamental_C2` still carries
...
Main result: `dist_selInv_le_of_path_regularity_fundamental_C2`.
-/
...
namespace SelInvPathRegularityFundamentalC2
...
`SelInvFrontNormalSpeedFundamentalC2.dist_selInv_le_of_front_normalSpeed_fundamental_C2` with the
...
curve. -/
theorem dist_selInv_le_of_path_regularity_fundamental_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvFrontNormalSpeedFundamentalC2.dist_selInv_le_of_front_normalSpeed_fundamental_C2
...
end SelInvPathRegularityFundamentalC2
