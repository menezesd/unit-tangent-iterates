...
`SelInvPathCurvatureFundamentalC2.exists_steering_dist_selInv_le_of_path_curvature_fundamental_C2`
...
Main result: `exists_steering_dist_selInv_le_of_path_period_fundamental_C2`.
-/
...
namespace SelInvPathPeriodFundamentalC2
...
those of
`SelInvPathCurvatureFundamentalC2.exists_steering_dist_selInv_le_of_path_curvature_fundamental_C2` with
...
theorem exists_steering_dist_selInv_le_of_path_period_fundamental_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathCurvatureFundamentalC2.exists_steering_dist_selInv_le_of_path_curvature_fundamental_C2
...
end SelInvPathPeriodFundamentalC2
