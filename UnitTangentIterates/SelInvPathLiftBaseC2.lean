...
`SelInvPathEmbeddedBaseC2.exists_steering_dist_selInv_le_of_path_embedded_base_C2` still
...
Main result: `dist_selInv_le_of_path_lift_base_C2`.
-/
...
namespace SelInvPathLiftBaseC2

open SelInvPathLiftFundamentalDriftC2
...
of
`SelInvPathEmbeddedBaseC2.exists_steering_dist_selInv_le_of_path_embedded_base_C2` with
...
`2κ̂/√(1−κ̂²)³`. -/
theorem dist_selInv_le_of_path_lift_base_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathEmbeddedBaseC2.exists_steering_dist_selInv_le_of_path_embedded_base_C2
