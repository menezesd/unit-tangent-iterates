...
`SelInvFrontClosingFundamentalC2.dist_selInv_le_of_front_closing_fundamental_C2` still carries the
...
`dist_selInv_le_of_front_normalSpeed_fundamental_C2`.
-/
...
namespace SelInvFrontNormalSpeedFundamentalC2

open SelInvFrontNormalSpeedC2
...
`SelInvFrontClosingFundamentalC2.dist_selInv_le_of_front_closing_fundamental_C2` with that derivative
and its bound replaced by the joint requirement that the normal speed be `C¹`
in the parameter. -/
theorem dist_selInv_le_of_front_normalSpeed_fundamental_C2 {p q : Data} (Γ : NormalPath p q)
    ...
    (hxi0 : ∀ t, frameTangential (rearOwnVelocity Γ.X V A P δ (SelInvFrontChangeVarC2.rearArclengthInv δ)) (rearOwnAngle (angleOfPath V A P) δ (SelInvFrontChangeVarC2.rearArclengthInv δ)) t 0 = 0)
  ...
  exact SelInvFrontClosingFundamentalC2.dist_selInv_le_of_front_closing_fundamental_C2
...
end SelInvFrontNormalSpeedFundamentalC2
