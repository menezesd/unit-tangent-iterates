...
`SelInvPathTaylorFundamentalDriftC2.dist_selInv_le_of_path_taylor_fundamental_drift_C2` still takes the selected
...
Main result: `exists_steering_dist_selInv_le_of_path_fundamental_drift_C2`.
-/
...
namespace SelInvPathSteeringExistsFundamentalDriftC2

open SelInvPathSteeringExistsFundamentalC2
...
those of `SelInvPathTaylorFundamentalDriftC2.dist_selInv_le_of_path_taylor_fundamental_drift_C2` with the
...
theorem exists_steering_dist_selInv_le_of_path_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathTaylorFundamentalDriftC2.dist_selInv_le_of_path_taylor_fundamental_drift_C2 (dn := dn) (δ := fun t s => dn t (s / P t))
...
end SelInvPathSteeringExistsFundamentalDriftC2
