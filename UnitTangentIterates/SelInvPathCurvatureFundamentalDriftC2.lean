...
`SelInvPathSteeringExistsFundamentalDriftC2.exists_steering_dist_selInv_le_of_path_fundamental_drift_C2` still
...
Main result: `exists_steering_dist_selInv_le_of_path_curvature_fundamental_drift_C2`.
-/
...
namespace SelInvPathCurvatureFundamentalDriftC2

open SelInvPathCurvatureFundamentalC2

open SelInvPathCurvatureC2
...
those of
`SelInvPathSteeringExistsFundamentalDriftC2.exists_steering_dist_selInv_le_of_path_fundamental_drift_C2` with the
...
theorem exists_steering_dist_selInv_le_of_path_curvature_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  exact SelInvPathSteeringExistsFundamentalDriftC2.exists_steering_dist_selInv_le_of_path_fundamental_drift_C2 (Kn := pathKn Γ.X P)
...
end SelInvPathCurvatureFundamentalDriftC2
