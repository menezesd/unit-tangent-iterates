...
`SelInvFrontRegularityFundamentalC2.dist_selInv_le_of_front_regularity_fundamental_C2` still carries
...
`dist_selInv_le_of_front_changevar_fundamental_C2`.
-/
...
namespace SelInvFrontChangeVarFundamentalC2
...
theorem dist_selInv_le_of_front_changevar_fundamental_C2 {p q : Data} (Γ : NormalPath p q)
    ...
    (hxi0 : ∀ t, frameTangential (rearOwnVelocity Γ.X V A P δ (rearArclengthInv δ)) (rearOwnAngle (angleOfPath V A P) δ (rearArclengthInv δ)) t 0 = 0)
  ...
  exact SelInvFrontRegularityFundamentalC2.dist_selInv_le_of_front_regularity_fundamental_C2
...
end SelInvFrontChangeVarFundamentalC2
