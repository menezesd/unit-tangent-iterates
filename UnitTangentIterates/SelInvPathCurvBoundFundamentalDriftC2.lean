...
`SelInvPathModulusFundamentalDriftC2.dist_selInv_le_modulus_of_path_fundamental_drift_C2` still asks separately
...
Main result: `dist_selInv_le_modulus_of_path_curv_fundamental_drift_C2`.
-/
...
namespace SelInvPathCurvBoundFundamentalDriftC2

open SelInvPathCurvBoundFundamentalC2
...
`SelInvPathModulusFundamentalDriftC2.dist_selInv_le_modulus_of_path_fundamental_drift_C2` with the two curvature
...
theorem dist_selInv_le_modulus_of_path_curv_fundamental_drift_C2 {p q : Data} (Γ : NormalPath p q)
  ...
  refine SelInvPathModulusFundamentalDriftC2.dist_selInv_le_modulus_of_path_fundamental_drift_C2 Γ hc hkmin hp ?_ hturnp hcq hkminq hq ?_ hturnq
...
end SelInvPathCurvBoundFundamentalDriftC2
